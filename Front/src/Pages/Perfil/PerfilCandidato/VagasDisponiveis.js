...
class VagasDisponiveis extends Component{
    constructor(props){
        super(props);
        this.state={
            ListaVaga : [],
    ...
    return (
        <div>
          <Vlibras/>
            ...
            <div className="VagasGerais">
                    {
                        this.state.ListaVaga.map( (Teste) => {
                            return (
                                <div className="identificador" key={Teste.idVaga}>
                                    <div className='bordinha2'>
                                    <h2>{Teste.titulo}</h2>
                                    <p>{Teste.cargo} </p>
                                    <p>{Teste.descricao}</p>
                                    <button><p>Candidatar-se</p></button>
            ...
            <div className="footerCandidato2">
              <img src={fundinho} alt="imagem"/>
            </div>
        </div>
      )
